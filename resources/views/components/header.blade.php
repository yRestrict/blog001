<header class="navbar navbar-expand-lg shadow fixed-top">
    <div class="container-fluid">
            ...
            <a class="navbar-brand fw-bold text-primary d-flex align-items-center" href="/">
                @if ($siteSetting && $siteSetting->site_logo_light)
                    <img src="{{ asset('uploads/logo/' . $siteSetting->site_logo_light) }}"
                        alt="{{ $siteSetting->site_title ?? config('app.name') }}" class="logo-dark" />
                    <img src="{{ asset('uploads/logo/' . $siteSetting->site_logo_dark) }}"
                        alt="{{ $siteSetting->site_title ?? config('app.name') }}" class="logo-white display-none" />
                @else
        ...
        {{-- Toggle Mobile --}}
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarDeskApp"
            aria-controls="navbarDeskApp" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="theme-switch-wrapper">
                    <label class="theme-switch" for="checkbox">
                        ...
                        <div class="slider round">
                            <svg class="icon-light text-warning" xmlns="http://www.w3.org/2000/svg" width="20"
                            ...
                            <svg class="icon-dark text-dark" xmlns="http://www.w3.org/2000/svg" width="20"
                                height="20" fill="currentColor" viewBox="0 0 16 16">
                                <path
