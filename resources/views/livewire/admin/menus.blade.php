<div>
    <style>
        ...
        .mir-url-row-inactive {
            opacity: .55;
        }

        .mir-url-inactive-text {
            font-style: italic;
            color: #9ca3af;
        }
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mir-label">
                                    ...
                                    @if ($editingHasChildren)
                                        <span class="mir-url-inactive-badge"
                                            title="Este item possui subitens — a URL é desativada automaticamente">
                                            <svg width="10" height="10" viewBox="0 0 12 12" fill="none"
                                                style="vertical-align:-.1em">
                                                <path d="M6 1a5 5 0 100 10A5 5 0 006 1zm0 4v3m0-5v.5"
                                ...
                                @if ($editingHasChildren)
                                    <div class="mir-url-hint">
                                        <svg width="11" height="11" viewBox="0 0 12 12" fill="none">
                                            <path d="M5 3.5L3.5 5 5 6.5M7 3.5L8.5 5 7 6.5M1 6a5 5 0 1010 0A5 5 0 001 6z"
                                                stroke="currentColor" stroke-width="1.2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                        Este item tem subitens — a URL fica inativa. Remova todos os subitens para
                                        ativá-la novamente.
                                    </div>
                                @else
                                    @error('url')
        ...
        <div class="mir-modal-dialog">
            <div class="mir-modal-content">
                ...
                <div class="mir-modal-footer">
                    ...
                    <button class="mir-btn-primary-lg" style="background: #ef4444;"
    ...
    @else
        <div class="cat-section">
            ...
            <div class="cat-section-header">
                <div>
                    <div class="cat-section-title">Menu</div>
                    <div class="cat-section-sub">Gerencie todos os menu do sistema</div>
                </div>
                @if (!$showForm)
                    <button class="mir-btn-primary-lg" wire:click="openAddForm(null)">
                        <svg width="11" height="11" viewBox="0 0 12 12" fill="none">
