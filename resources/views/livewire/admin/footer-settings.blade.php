<div>
    ...
    {{-- ================================================================ --}}
    {{-- SECTION CARD: CATEGORIAS POPULARES                                --}}
    {{-- ================================================================ --}}
    ...
    {{-- ================================================================ --}}
    {{-- SCOPED STYLES (apenas ftr- específicos)                          --}}
    {{-- ================================================================ --}}
    <style>
        /* ── Section Card ──────────────────────────────────── */
        .ftr-section-card {
        ...
        .ftr-selection-card:hover {
            border-color: #d1d5db;
            background: #f9fafb;
        }
        .ftr-selection-card.active {
            border-color: #6366f1;
            background: rgba(99,102,241,.03);
            box-shadow: 0 2px 8px rgba(99,102,241,.1);
        }
        .ftr-selection-card.active::before {
            content: '';
            position: absolute;
        ...
        .ftr-selection-card.active .ftr-selection-icon {
        ...
        .ftr-selection-title {
            display: block;
            font-size: .88rem; font-weight: 600; color: #1a1d23;
        }
        .ftr-selection-desc {
        ...
        .ftr-selection-card.active .ftr-selection-check {
            color: #6366f1;
        }
    </style>
